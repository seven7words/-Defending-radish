...
using System.Collections;
 ...
 public class Monster : Role {
    ...
    public  MonsterType m_MonsterType = MonsterType.Monster0;//怪物类型

     private Vector3[] m_Path= null;//路径拐点
     private int m_PointIndex = -1;//下一拐点索引值
     private bool m_IsReached = false;//是否到达终点
