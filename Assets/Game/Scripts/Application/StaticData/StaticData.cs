...
public class StaticData : Singleton<StaticData> {
    ...
    void InitMonsters()
    {
        ...
        m_Monsters.Add(0, new MonsterInfo() { ID = 0, Hp = 1, MoveSpeed = 5f ,Price = 1});
        m_Monsters.Add(1, new MonsterInfo() { ID = 1, Hp = 2, MoveSpeed = 5f , Price = 2 });
        m_Monsters.Add(2, new MonsterInfo() { ID = 2, Hp = 5, MoveSpeed = 5f, Price = 5});
        m_Monsters.Add(3, new MonsterInfo() { ID = 3, Hp = 20, MoveSpeed = 5f, Price = 10 });
        m_Monsters.Add(4, new MonsterInfo() { ID = 4,Hp = 20, MoveSpeed = 5f, Price = 15 });
        m_Monsters.Add(5, new MonsterInfo() { ID = 5,Hp = 100, MoveSpeed = 5f, Price = 20 });
    }
    ...
    void InitTowers()
    {
        ...
        m_Towers.Add(0, new TowerInfo() { ID = 0, PrefabName = "Bottle", NormalIcon = "Bottle/Bottle01", DisabledIcon = "Bottle/Bottle00", MaxLevel = 3, BasePrice = 1, ShotRate = 2f, GuardRange = 3f, UseBulletID = 0 });
